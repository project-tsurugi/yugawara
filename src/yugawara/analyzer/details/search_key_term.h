...
public:
    ...
    [[nodiscard]] std::unique_ptr<::takatori::scalar::expression> purge_equivalent_factor();
    [[nodiscard]] std::unique_ptr<::takatori::scalar::expression> clone_equivalent_factor();
    [[nodiscard]] std::unique_ptr<::takatori::scalar::expression> purge_lower_factor();
    [[nodiscard]] std::unique_ptr<::takatori::scalar::expression> purge_upper_factor();
...
private:
    ...
    std::unique_ptr<::takatori::scalar::expression> purge(
