...
public:
    ...
    using entity_type = std::variant<
            ...
            std::shared_ptr<function::declaration const>, // function
    ...
    /**
     * @brief creates a new instance which represents a value generated by function call.
     * @param source the source function
     * @see column_value_kind::function
     */
    column_value(std::shared_ptr<function::declaration const> source) noexcept; // NOLINT(*-explicit-constructor, *-explicit-conversions)
